...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<F12>u', dapui.toggle, { desc = '[]debugger [U]I' })
    vim.keymap.set('n', '<F1>', dap.continue, { desc = '[]debugger Continue/start' })
    ...
    vim.keymap.set('n', '<F5>', dap.toggle_breakpoint, { desc = '[]debugger Breakpoint' })
    ...
    vim.keymap.set('n', '<F12>c', function()
